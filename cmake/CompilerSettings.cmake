...
function(apply_compiler_settings target options)
  ...
  target_compile_options(${target} ${options}
    ...
    $<$<AND:$<CXX_COMPILER_ID:MSVC>,$<CONFIG:MinSizeRel>>:/DBUILD_TYPE_MINSIZEREL /DNDEBUG /O1>
    $<$<AND:$<CXX_COMPILER_ID:MSVC>,$<CONFIG:RelWithDebInfo>>:/DBUILD_TYPE_RELWITHDEBINFO /DNDEBUG /Zi /O2>
